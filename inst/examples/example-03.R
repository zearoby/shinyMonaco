...
server <- function(input, output, session) {
   output$editor1 <- shinyMonaco::renderEditor({
      shinyMonaco::editor(readLines("./example-01.R"), language = "r", showStatusBar = TRUE)
   })
   output$editor2 <- shinyMonaco::renderEditor({
      shinyMonaco::editor(readLines("./example-03.R"), language = "r", showStatusBar = TRUE)
   })
   output$diffEditor <- shinyMonaco::renderdiffEditor({
      shinyMonaco::diffEditor(readLines("./example-01.R"), readLines("./example-03.R"), language = "r")
   })
